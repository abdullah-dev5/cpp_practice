...
Smartphones phoneObject3;
phoneObject3.Brand="Redmi";
phoneObject3.Model="9t";
phoneObject3.year=2022;

cout<<phoneObject3.Brand<<" "<<phoneObject3.Model<<" "<<phoneObject3.year<<endl;
return 0;
}
